...
class video:
    ...
    def preview(self):
        ...
        try:
            T = driver.find_element_by_xpath('//*[@id="view255"]/div[2]/div[2]/div[3]/div[1]/div[4]').click()
            #text = driver.find_element_by_xpath(
             #   '/html/body/div[5]/div/div[2]/div[3]/div/div[2]/div/div[1]/div[3]/div').click()
            time.sleep(5)

            titleArea = driver.find_element_by_xpath(
                '//*[@id="view255"]/div[2]/div[2]/div[3]/div[2]/div/div/div/div[1]/textarea').clear()
            titleArea = driver.find_element_by_xpath(
                '//*[@id="view255"]/div[2]/div[2]/div[3]/div[2]/div/div/div/div[1]/textarea')
        except:
            T = driver.find_element_by_xpath('//*[@id="view253"]/div[2]/div[2]/div[3]/div[1]/div[4]').click()
            # text = driver.find_element_by_xpath(
            #   '/html/body/div[5]/div/div[2]/div[3]/div/div[2]/div/div[1]/div[3]/div').click()
            time.sleep(5)

            titleArea = driver.find_element_by_xpath(
                '//*[@id="view253"]/div[2]/div[2]/div[3]/div[2]/div/div/div/div[1]/textarea').clear()
            titleArea = driver.find_element_by_xpath(
                '//*[@id="view253"]/div[2]/div[2]/div[3]/div[2]/div/div/div/div[1]/textarea')

        titleArea.send_keys("Data Recovery in " + self.city)
        time.sleep(2)
        try:
            time.sleep(20)
            preview = driver.find_element_by_xpath(
    ...
    def produce(self):
        ...
        desc = driver.find_element_by_xpath(
            '//*[@id="js-Description"]')
        desc.send_keys('Data Recovery in ' + self.city + ' \nhttp://www.jtgsystems.com/ at 1(888)820-0428')
        try:
