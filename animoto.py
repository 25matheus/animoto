...
class makeVideo:
    ...
    def produce(self):
        ...
        desc = driver.find_element_by_xpath(
            '//*[@id="js-Description"]')
        desc.send_keys(' http://pinestreetdental.ca ' +"\n" +'Niagara Dental Clinic - Pine Street Dental located in Thorold Providing Niagara Dental Services such as Teeth Whitening, Teeth Cleaning, Cosmetic Dentistry, Dental Implants, Tooth Extractions, Wisdom Teeth Removal, Dentures, and Denture implants. Teeth implants and more financial options to our dental patients to help make your smile affordable. We are accepting new patients from everywhere including Beamsville, Chippawa, Crystal Beach, Dunnville, Fort Erie, Grimsby, Hamilton, Lincoln, Niagara, Niagara Falls, Niagara on the Lake, Pelham, Port Colborne, St.Catharines, Stoney Creek, Thorold, Vineland, Wainfleet, Welland, West Lincoln and all other areas. Niagara Family Dentist is here to help here at Pine Street Dental!')
        try:
